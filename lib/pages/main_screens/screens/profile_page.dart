              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    GlobalVariables.spaceMedium(context),
                    // FAVOURITES STATS
                    Consumer<CelestialBodiesProvider>(
                      builder: (context, infoProvider, child) {
                        double percentage = infoProvider.getFavorites().length /
                            infoProvider.celestialBodies.length;
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text: (percentage * 100)
                                            .toStringAsFixed(0),
                                        style: FontStyles.headerLarge.copyWith(
                                            color: AppColors.active,
                                            fontSize: 70),
                                      ),
                                      TextSpan(
